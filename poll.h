...
public:
	...
	// Monte Carlo Method
	// ignore meetings within min_meet_dist (which are already computed through mc_tree)
	...
	/*
	Poll for the top-k ground truth for first num_query in query_file.
	Results of various methods are in dirs.
	Polled results are written to poll_gt_dir.
	*/
